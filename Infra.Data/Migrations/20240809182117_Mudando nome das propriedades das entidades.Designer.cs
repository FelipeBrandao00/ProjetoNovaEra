...
namespace Infra.Data.Migrations
{
    ...
    [Migration("20240809182117_Mudando nome das propriedades das entidades")]
    partial class Mudandonomedaspropriedadesdasentidades
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Aluno", b =>
                {
                    b.HasOne("Domain.Entities.Usuario", "Usuario")
                        .WithOne("Aluno")
                        .HasForeignKey("Domain.Entities.Aluno", "CdAluno")
            ...
            modelBuilder.Entity("Domain.Entities.Professor", b =>
                {
                    b.HasOne("Domain.Entities.Usuario", "Usuario")
                        .WithOne("Professor")
                        .HasForeignKey("Domain.Entities.Professor", "CdProfessor")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
